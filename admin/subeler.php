...
?>
										<tr id="item-<?php echo $row["haber_ust_id"]; ?>" role="row" class="even">
											...
											<td class=""><?php echo $row["haber_description"]; ?></td>
					...
					if(!empty($_POST['haber_baslik']) || !empty($_POST['haber_aciklama'])) {
						...
						foreach ($_POST AS $k=>$v) {
							...
							if (substr($k,0,5) == "form_") {
								...
								$insert = $db->prepare("INSERT INTO ".TABLE." SET haber_baslik = ?, haber_seo = ?, haber_aciklama = ?, haber_description = ?, haber_kisaaciklama = ?,  haber_telefon = ?,   haber_resim = ?, dil_id = ?, haber_durum = ?, haber_ust_id = ?");
								$insert->execute(array($haber_baslik[$key], Seo_Link_Cevir($haber_baslik[$key]), $haber_aciklama[$key], $haber_description[$key], $haber_kisaaciklama[$key],   $haber_telefon[$key], $haber_resim, $key, $haber_durum, $LastID));
													...
													<div class="row">
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																...
																<input type="text" name="haber_baslik[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Firma İsmi" required="">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Adres</label>
																<input type="text" name="haber_description[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Adres" required="">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Websitesi</label>
																<input type="text" name="haber_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder=" Websitesi" required="">
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Eposta</label>
																<input type="text" name="haber_aciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder=" Eposta" required="">
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Telefon</label>
																<input type="text" name="haber_telefon[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder=" Telefon" required="">
															</div>
														</div>
						...
						if(!empty($_POST['haber_baslik']) || !empty($_POST['haber_aciklama'])) {
							...
							foreach ($_POST AS $k=>$v) {
								...
								if (substr($k,0,5) == "form_") {
									...
									$update = $db->prepare("UPDATE ".TABLE." SET  haber_baslik = ?, haber_seo = ?, haber_aciklama = ?, haber_description = ?, haber_kisaaciklama = ?,  haber_telefon = ?,  haber_resim = ?, haber_durum = ? WHERE haber_ust_id = ? AND dil_id = ?");
									$update->execute(array($haber_baslik[$key], Seo_Link_Cevir($haber_baslik[$key]), $haber_aciklama[$key],  $haber_description[$key], $haber_kisaaciklama[$key],  $haber_telefon[$key],   $haber_resim, $haber_durum, $id, $key));
								}
							}
							if ($update) {
...
?>
				...
				<form action="#" method="POST" enctype="multipart/form-data" id="form" style="display: inline-flex; ">
					<div class="col-xl-8 col-xxl-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Şube Düzenle</h4>
                            </div>
                            <div class="card-body">
								<div class="step-app" id="demo">
									<ul class="step-steps">
												...
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Firma İsmi</label>
																<input type="text" name="haber_baslik[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Firma İsmi" required="" value="<?php echo GetTableValue("haber_baslik",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Adres</label>
																<input type="text" name="haber_description[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Adres" required="" value="<?php echo GetTableValue("haber_description",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Websitesi</label>
																<input type="text" name="haber_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Websitesi" required="" value="<?php echo GetTableValue("haber_kisaaciklama",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Eposta</label>
																<input type="text" name="haber_aciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Eposta" required="" value="<?php echo GetTableValue("haber_aciklama",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Telefon</label>
																<input type="text" name="haber_telefon[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Telefon" required="" value="<?php echo GetTableValue("haber_telefon",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
