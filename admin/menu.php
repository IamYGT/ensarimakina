                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										<span class="text-black"><?php echo $_SESSION['uye_adsoyad']; ?></span>
										<p class="fs-12 mb-0">Yönetici</p>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="cikis" class="dropdown-item ai-icon">
		...
		<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li>
						<a class="ai-icon"  href="anasayfa" aria-expanded="false">
                    ...
                    <li>
						<a class="ai-icon" href="slayt" aria-expanded="false">
							<i class="fas fa-sliders-h"></i>
							<span class="nav-text">Slaytlar</span>
						</a>
                    </li>
                    <li>
						<a class="ai-icon" href="haberler" aria-expanded="false">
							<i class="fas fa-sliders-h"></i>
                     ...
                     <li>
						<a class="ai-icon" href="hizmetler" aria-expanded="false">
							<i class="fas fa-ring"></i>
							<span class="nav-text">Hizmetlerimiz</span>
						</a>
                    </li>

                     <li>
						<a class="ai-icon" href="nedenildi" aria-expanded="false">
							<i class="fas fa-ring"></i>
                     ...
                     <li>
						<a class="ai-icon" href="urunlerimiz" aria-expanded="false">
							<i class="fas fa-question"></i>
							<span class="nav-text">Ürünlerimiz</span>
						</a>
                    </li>
					...
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Dil Seçenekleri</span>
						</a>
                        <ul aria-expanded="false" class="mm-collapse">
                            <li><a href="diller">Diller</a></li>
                            <li><a href="diller?do=words">Kelimeler</a></li>
                         </ul>
                    </li>


					<li>
						<a class="ai-icon" href="ayarlar" aria-expanded="false">
							<i class="fas fa-cog"></i>
							<span class="nav-text">Genel Ayarlar</span>
						</a>
					</li>
					<li>
						<a class="ai-icon" href="cikis" aria-expanded="false">
				...
				<div class="copyright">
					<p><strong>Memsidea Group</strong> © Her hakkı saklıdır.</p>
 				</div>
			</div>
        </div>
