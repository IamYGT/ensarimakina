                                ...
                                <div class="custom-tab-1">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                           ...
                                           <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#sayilar"><i class="la la-archive mr-2"></i>Sayılar</a>
																					</li>
														...
														<div class="card-body">
															<div class="form-validation">
																<div class="row">
																	...
																	<div class="col-lg-6 mb-3">
																		<div class="form-group row">
																			<label class="col-lg-4 col-form-label" for="val-suggestions"> Telefon 2 <span class="text-danger">*</span> </label>
																			<div class="col-lg-8">
																	...
																	<div class="col-xl-12 mb-3">
																		<div class="form-group row">
																			...
																			<div class="col-lg-10">
																				<textarea class="form-control" name="strColorThree" rows="4" id="comment"><?php echo $row_info["strColorThree"]?></textarea>
																			</div>
																		</div>
																	</div>
																								...
																								<div class="card">
																									<div class="card-body">
																										<div class="row">
																											<div class="col-xl-12 col-lg-12 mb-3">
																												<div class="form-group row">
																													<label class="col-lg-4 col-form-label" for="">Müşteri Sayısı <span class="text-danger">*</span> </label>
																													<div class="col-lg-8">
																														<div class="input-group mb-3 input-primary-o">

																															<input type="text" name="dosyasayisi" class="form-control" placeholder="Müşteri Sayısı" value="<?php echo $row_info["dosyasayisi"]?>">
																														</div>
																													</div>
																												</div>
																											</div>
																											<div class="col-xl-12 col-lg-12 mb-3">
																												<div class="form-group row">
																													<label class="col-lg-4 col-form-label" for="">Müşteri Memnuniyeti <span class="text-danger">*</span></label>
																													<div class="col-lg-8">
																														<div class="input-group mb-3 input-primary-o">

																															<input type="text" name="mutlumusteri" class="form-control" placeholder="Müşteri Memnuniyeti"  value="<?php echo $row_info["mutlumusteri"]?>">
																														</div>
																													</div>
																												</div>
																											</div>
																											<div class="col-xl-12 col-lg-12 mb-3">
																												<div class="form-group row">
																													<label class="col-lg-4 col-form-label" for="">Proje Sayısı  <span class="text-danger">*</span>  </label>
																													<div class="col-lg-8">
																														<div class="input-group mb-3 input-primary-o">

																															<input type="text" name="tecrube" class="form-control" placeholder="Proje Sayısı"  value="<?php echo $row_info["tecrube"]?>">
																														</div>
																													</div>
																												</div>
																											</div>
																												...
																												<div class="form-group row">
																													...
																													<div class="col-lg-8">
																														<div class="input-group mb-3 input-primary-o">
																															...
																															<input type="text" name="muhendis" class="form-control" placeholder="Yıllık Tecrübe"  value="<?php echo $row_info["muhendis"]?>">
																														</div>
																													</div>
																												</div>
																											</div>
													...
													<div class="card">
														<div class="card-body">
															<div class="row">
																<div class="col-xl-12 col-lg-12 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Number of Vehicles <span class="text-danger">*</span> </label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">

																				<input type="text" name="dosyasayisi" class="form-control" placeholder="Number of Vehicles" value="<?php echo $row_info["dosyasayisi"]?>">
																			</div>
																		</div>
																	</div>
																</div>
																<div class="col-xl-12 col-lg-12 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Happy Customers <span class="text-danger">*</span></label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">

																				<input type="text" name="mutlumusteri" class="form-control" placeholder="Happy Customers"  value="<?php echo $row_info["mutlumusteri"]?>">
																			</div>
																		</div>
																	</div>
																</div>
																<div class="col-xl-12 col-lg-12 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Years of Experience  <span class="text-danger">*</span>  </label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">

																				<input type="text" name="tecrube" class="form-control" placeholder="Years of Experience"  value="<?php echo $row_info["tecrube"]?>">
																			</div>
																		</div>
																	</div>
																</div>
																<div class="col-xl-12 col-lg-12 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Engineer   <span class="text-danger">*</span> </label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">

																				<input type="text" name="muhendis" class="form-control" placeholder="Engineer"  value="<?php echo $row_info["muhendis"]?>">
																			</div>
																		</div>
																	</div>
																</div>
													...
													<div class="card">
														<div class="card-body">
															<div class="row">
																...
																<div class="col-xl-6 col-lg-6 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Twitter <span class="text-danger">*</span></label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">
																...
																<div class="col-xl-6 col-lg-6 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Skype  <span class="text-danger">*</span>  </label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">

																				<input type="text" name="strSkype" class="form-control" placeholder="Kullanıcı Adı"  value="<?php echo $row_info["strSkype"]?>">
																			</div>
																		</div>
																	</div>
																</div>
